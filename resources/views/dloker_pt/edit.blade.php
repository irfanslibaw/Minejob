      ...
      <div class="">
        <div class="">
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ url('dloker_pt/' .$dloker->id) }}" method="POST">
                <div class="header">Edit Loker Di Perusahaan Anda</div>
                <div class="knkr d-flex">
                    ...
                    <div class="knn">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="bagian_pekerjaan" required value="{{ $dloker->bagian_pekerjaan }}" class="form-control w-200 h-75">
                      </div>
                      <div class="mb-3">
                        <label class="w-100 mb-2">Tanggal Akhir</label>
                        <input type="date" name="tanggal_akhir" required value="{{ $dloker->tanggal_akhir }}" class="form-control  w-200 h-75">
                      </div>

                      <div class="mb-3">
                        <label class="w-100 mb-2">Tingkat pekerjaan</label>
                        <input type="text" name="tingkat_pekerjaan" required value="{{ $dloker->tingkat_pekerjaan }}"  class="form-control w-200 h-75">
                      </div>
                      <div class="mb-3 ">
                        <label class="w-100 mb-2">Minimal kelulusan</label>
                        <input type="text" name="minimal_kelulusan" required value="{{ $dloker->minimal_kelulusan }}"  class="form-control  w-200 h-75" >
                      </div>
                        <div class="mb-3">
                            <label class="w-100 mb-2">Pengalaman Kerja</label>
                            <input type="text" name="pengalaman" required value="{{ $dloker->pengalaman }}"  class="form-control w-150 h-75">
                        </div>
                  </div>
                  ...
                  <div class="kri me-5">
                      <div class="mb-3 ">
                        ...
                        <input type="text" name="jenis_pekerjaan" required value="{{ $dloker->jenis_pekerjaan }}"  class="form-control  w-350 h-75">
                      </div>
                    <div class="mb-3">
                      <label class="w-100 mb-2 ">Deskripsi Pekerjaan</label>
                      <textarea name="deskripsi_pekerjaan" value="{{ $dloker->deskripsi_pekerjaan }}" class=" panjang form-control">{{ $dloker->deskripsi_pekerjaan }}</textarea>
                    </div>
                    <div class="mb-3">
                      <label class="w-100 mb-2">Persyaratan</label>
                      <textarea type="text" name="persyaratan" value="{{ $dloker->persyaratan }}" class="panjang form-control">{{ $dloker->persyaratan }}</textarea>
                    </div>
                  </div>
                </div>
