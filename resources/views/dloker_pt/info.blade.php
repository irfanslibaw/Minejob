...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/infolokerpt.css') }}">
  </head>
  <body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="deskripsi mt-5 mb-3">
                            <h5 style="">Deskripsi Pekerjaan:</h5>
                            <ul>
                                <p>
                                {{ $dloker->deskripsi_pekerjaan }}
                                </p>
                            </ul>

                        </div>
                        <div class="syarat mt-5 mb-3">
                            <h5 style="">Persyaratan</h5>
                            <ul>
                               <p>
                                {{ $dloker->persyaratan }}
                            </p>
                        ...
                        <div class="text-center">
                            ...
                            <div class="back h-50 w-100">
                               <a href="{{ route('dloker_pt') }}"><button class="btn">Kembali</button></a>
                            </div>
                        </center>
                          </div>
                        <div>
