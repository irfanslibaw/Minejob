...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/info-loker-user.css') }}">
  </head>
  <body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="infotambahan">
                            <h3 style="text-align: center; font-size: 20px;"><b>Informasi Tambahan</b></h3>
                        ...
                        <div class="text-center">
                            <center>
                            <div class="tombol h-100 w-200">
                               <a href="{{ url('lamaran/' .$dloker->id. '/create')}}"><button class="btn">Apply</button></a>
                            </div>
                            </center>
                            <center>
                                <div class="tombol h-100 w-200">
                                   <a href="{{ route('lamaran.index') }}"><button class="back  btn">Back</button></a>
                                </div>
                            </center>
                        <div>
